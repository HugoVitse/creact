...
var ASM_CONSTS = {
  92736: () => { if (window.wakeUpCreact) { window.wakeUpCreact(); } },  
 92792: () => { if (window.wakeUpCreact) { window.wakeUpCreact(); } },  
 92848: () => { if (document.fullscreenElement) return 1; },  
 92894: () => { return Module.canvas.width; },  
 92926: () => { return parseInt(Module.canvas.style.width); },  
 92974: () => { document.exitFullscreen(); },  
 93001: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 93073: () => { if (document.fullscreenElement) return 1; },  
 93119: () => { return Module.canvas.width; },  
 93151: () => { return screen.width; },  
 93176: () => { document.exitFullscreen(); },  
 93203: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 93397: () => { return window.innerWidth; },  
 93423: () => { return window.innerHeight; },  
 93450: () => { if (document.fullscreenElement) return 1; },  
 93496: () => { return Module.canvas.width; },  
 93528: () => { return parseInt(Module.canvas.style.width); },  
 93576: () => { if (document.fullscreenElement) return 1; },  
 93622: () => { return Module.canvas.width; },  
 93654: () => { return screen.width; },  
 93679: () => { return window.innerWidth; },  
 93705: () => { return window.innerHeight; },  
 93732: () => { if (document.fullscreenElement) return 1; },  
 93778: () => { return Module.canvas.width; },  
 93810: () => { return screen.width; },  
 93835: () => { document.exitFullscreen(); },  
 93862: () => { if (document.fullscreenElement) return 1; },  
 93908: () => { return Module.canvas.width; },  
 93940: () => { return parseInt(Module.canvas.style.width); },  
 93988: () => { document.exitFullscreen(); },  
 94015: ($0) => { Module.canvas.style.opacity = $0; },  
 94053: () => { return screen.width; },  
 94078: () => { return screen.height; },  
 94104: () => { return window.screenX; },  
 94131: () => { return window.screenY; },  
 94158: () => { return window.devicePixelRatio; },  
 94194: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94247: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94298: () => { Module.canvas.style.cursor = 'none'; },  
 94335: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94591: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94642: () => { if (document.pointerLockElement) return 1; },  
 94689: () => { if (document.fullscreenElement) return 1; },  
 94735: () => { return window.innerWidth; },  
 94761: () => { return window.innerHeight; }
};
...
var _update_mouse = Module['_update_mouse'] = makeInvalidEarlyAccess('_update_mouse');
var _init_headless = Module['_init_headless'] = makeInvalidEarlyAccess('_init_headless');
var _resize_frame = Module['_resize_frame'] = makeInvalidEarlyAccess('_resize_frame');
var _initCreact = Module['_initCreact'] = makeInvalidEarlyAccess('_initCreact');
var _destroyCreact = Module['_destroyCreact'] = makeInvalidEarlyAccess('_destroyCreact');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['update_mouse'] != 'undefined', 'missing Wasm export: update_mouse');
  assert(typeof wasmExports['init_headless'] != 'undefined', 'missing Wasm export: init_headless');
  assert(typeof wasmExports['resize_frame'] != 'undefined', 'missing Wasm export: resize_frame');
  assert(typeof wasmExports['initCreact'] != 'undefined', 'missing Wasm export: initCreact');
  assert(typeof wasmExports['destroyCreact'] != 'undefined', 'missing Wasm export: destroyCreact');
  ...
  _update_mouse = Module['_update_mouse'] = createExportWrapper('update_mouse', 3);
  _init_headless = Module['_init_headless'] = createExportWrapper('init_headless', 3);
  _resize_frame = Module['_resize_frame'] = createExportWrapper('resize_frame', 3);
  _initCreact = Module['_initCreact'] = createExportWrapper('initCreact', 0);
  _destroyCreact = Module['_destroyCreact'] = createExportWrapper('destroyCreact', 1);
